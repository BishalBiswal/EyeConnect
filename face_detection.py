...
shape_predictor = "C:/Users/Bishal/Documents/programming files/EyeConnect/shape_predictor_68_face_landmarks.dat"
    ...
    if landmark_points:
        ...
        for id, landmark in enumerate(landmarks[474:478]):
            ...
            if id == 1:
                ...
                pyag.moveTo(
                    screen_x, screen_y, duration=duration
    ...
    if landmark_points and INPUT_MODE == True:
        ...
        for id, landmark in enumerate(landmarks[474:478]):
            ...
            if id == 1:
                ...
                pyag.moveTo(2 * screen_x, screen_y, duration=duration)
